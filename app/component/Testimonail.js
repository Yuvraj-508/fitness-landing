...
function Testimonail() {
  ...
  return (
    <div className="testmonail w-full min-h-screen flex flex-col  items-center overflow-hidden ">
        <div className="w-full flex flex-col mt-25 items-center gap-15 justify-center ">
      <h1 className="text-[44px] flex items-center gap-7  font-bold leading-15 relative">
        Hear from Our Users <motion.img  src="/heroI/arrow.png" alt="" className="w-25 absolute right-0 top-0 translate-x-25 -rotate-40" />
      </h1>
